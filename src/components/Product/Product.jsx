...
const toDataUrl = async (url, callback) => {
  try {
    ...
    // let datafromAPI = await axios.get("http://40.118.208.114/static/media/littleJohn.c39be931.jpg", { responseType: 'arraybuffer', crossDomain: true });
    ...
    let data = `data:${datafromAPI.headers[
      "content-type"
...
class Product extends Component {
  ...
  async componentDidMount() {
    ...
    console.log(this.props, "in porduct adidmpint");
